...
namespace MyRecipes
{
    public class RecipeData
    {
        ...
        private static RecipeData _recipeData; 
        ...
        public void GenerateData()
        {
            ...
            string image = "6119674.jpg";
            Recipe recipe1 = new Recipe(id, name, description, time, ingredients, instructions, image);
            ...
            image = "5136042.jpg";
            Recipe recipe2 = new Recipe(id, name, description, time, ingredients, instructions, image);
            ...
            image = "4684123.jpg";
            Recipe recipe3 = new Recipe(id, name, description, time, ingredients, instructions, image);
            ...
            image = "4473147.jpg";
            Recipe recipe4 = new Recipe(id, name, description, time, ingredients, instructions, image);
            ...
            image = "6155203.jpg";
            Recipe recipe5 = new Recipe(id, name, description, time, ingredients, instructions, image);
            ...
            image = "5151529.jpg";
            Recipe recipe6 = new Recipe(id, name, description, time, ingredients, instructions, image);
